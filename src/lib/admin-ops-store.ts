...
const DEFAULT_DATA: AdminOpsData = {
  ...
  cronSchedules: [
    ...
    },
    {
      ...
      schedule: "17 * * * *",
      purpose: "Archive conservative hourly NHL/NBA/MLB aggregated odds snapshots for line-history and freshness tracking.",
      owner: "Odds pipeline",
      ...
      lastFailureAt: null,
      consecutiveFailures: 0,
      notes: "Conservative cadence by design to limit upstream load while seeding usable history.",
      updatedAt: nowIso(),
    },
  ],
  incidents: [],
