  ...
  return (
    <div className="mx-3 my-3 rounded-2xl border border-dark-border bg-dark-surface/70 px-4 py-4 shadow-[0_8px_30px_rgba(0,0,0,0.18)]">
      <Link href={getPlayerTrendHrefFromProp(prop)} className="block">
        ...
        <div className="mt-3 flex items-center justify-between rounded-xl border border-dark-border/70 bg-dark-bg/40 px-3 py-2 text-[11px] text-gray-400">
          <span>Tap to open full trend analysis</span>
          <span className="text-accent-blue">View →</span>
        </div>
      </Link>
